...
class CustomCupertinoJournalDatePicker {
  ...
  Future<void> selectDate(BuildContext context, Function(int) onMonthChanged,
    ...
    await showCupertinoModalPopup(
      ...
      builder: (context) {
        return BlocBuilder<JournalDateCubit, Date>(builder: (context, state) {
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: CustomCupertinoPicker(
                          ...
                          onChangedCallback: (int index) {
                            selectedDay = index + 1;
                            context.read<JournalDateCubit>().updateDay(selectedDay);
                          },
                          dateTimeList: List.generate(
                            31,
                            (index) {
                        ...
                        Container(
                          ...
                          child: CupertinoButton(
                            ...
                            onPressed: () {
                              ...
                              context.read<JournalDateCubit>().updateDay(DateTime.now().day);
                              yearController
