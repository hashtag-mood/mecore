                  ...
                  return Align(
                    ...
                    child: Container(
                      ...
                      child: Align(
                        ...
                        child: Text(
                          (state.is24Hour) ? afternoon24Hours[index] : afternoon12Hours[index],
                          style: TextStyle(
                            fontSize: 22,
                ...
                (index) {
                  if (startIndex != null && endIndex != null) {
                    for (int i = 0; i < 12; i++) {
                      if (startIndex! <= i && i <= endIndex! ||
                        ...
                        afternoonColors[i] = state.afternoonColor;
                      }
                    }
                  }
                  ...
                  return Align(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: (afternoonColors.containsKey(index))
                            ? afternoonColors[index]
                            : backgroundColor,
                        border: Border(
                          right: mainBorderSide,
                          bottom:
                        ...
                        child: (settingState.showMinute) ? (index.isEven)
                            ? Align(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      fontSize: 15,
                                      color: (afternoonColors[index] != null &&
                                              afternoonColors[index]!
                                                      .computeLuminance() <
                                                  0.3)
                                          ? backgroundColor
